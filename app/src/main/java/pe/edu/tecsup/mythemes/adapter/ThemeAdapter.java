...
import pe.edu.tecsup.mythemes.interfaces.FragmentInterface;
...
public class ThemeAdapter extends RecyclerView.Adapter<ThemeAdapter.ThemeViewHolder> {
    ...
    public static class ThemeViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick( View v) {
            ...
            builder.setMessage("¿Eliminar elemento?")
            .setPositiveButton("Sí", new DialogInterface.OnClickListener() {
                ...
                @Override
                public void onClick(DialogInterface dialog, int which) {
//                    Toast.makeText(v.getContext(),"Se cancela",Toast.LENGTH_SHORT).show();
                }
            }).show();
        }
    }
    ...
    public ThemeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater
                ...
                .inflate(this.fragmentId, parent, false);
